...
var audio = new Audio('./music/cave.mp3');
audio.loop = true;
audio.play();
...
function Spike(pos, ch) {
	this.pos = pos.plus(new Vector(-1.5, -0.8));
...
Bolt.prototype.act = function(step) {
...
var zap= new Audio('./music/zap.mp3');
var levelClear = new Audio('./music/pika.wav');
var cry = new Audio('./music/cry.wav');

Level.prototype.playerTouched = function(type, actor) {

  if (type == "fire" && this.status == null) {
    this.status = "lost";
    this.finishDelay = 1;
    cry.play()
...
var gameWin = new Audio('./music/victory.wav');
